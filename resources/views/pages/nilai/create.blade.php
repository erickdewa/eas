                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Tahun</label>
                                        <input type="text" class="form-control" name="year" placeholder="Tahun Exc: 2023/2024">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="nbi" class="form-control" placeholder="Mata Kuliah">
                                            @foreach ($nbi as $nbi)
                                                <option value="{{ $nbi->nbi }}">{{ $nbi->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="code_mk" class="form-control" placeholder="Mata Kuliah">
                                            @foreach ($mk as $mk)
                                                <option value="{{ $mk->code }}">{{ $mk->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Nilai</label>
                                        <input type="text" class="form-control" name="nilai" placeholder="Nilai 1-100">
                                    </div>
                                </div>
                            </div>
                        </div>
